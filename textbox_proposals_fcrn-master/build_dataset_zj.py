...
def generate_dataset(db_location, output_location):
  ...
  for cur_db in dbs:
	...
	in_db = scipy.io.loadmat(db_location + "/" + cur_db)#"/notebooks/data/str/SynthText/gt.mat")
	print type(in_db)
...
if __name__ == "__main__":
    ...
    generate_dataset(db_dir, output_dir)
>>>>>>> f0c9c2d5c05b8578baec6dad458cc7921adf4fd1
